...
public class ShowEffectModule implements ExtraModule {
    ...
    public void showEffect(Object player,Object mob) throws Exception {
        ...
        if (this.mob){
            ...
            rx = pos.get(0) + x;
            ry = pos.get(1) + y;
            MSUtils.doMethod(player,"showNpcEffectPlay",0,path,duration,rx,ry,true,0,true,0,"intro");
        }
        else if (block){
            ...
            MSUtils.doMethod(player,"showNpcEffectPlay",0,path,duration,rx,ry,true,0,false,0,"intro");
        }
    }
